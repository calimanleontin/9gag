                                                                ...
                                                                <div class="list-group-item">
                                                                    ...
                                                                    <div>
                                                                        @if(!Auth::guest())
                                                                            ...
                                                                            @if($rating == null)
                                                                                <a href="/gag/response/like/{{$reply->id}}"><span class="glyphicon glyphicon-thumbs-up gray"></span></a>
                                                                                <a href="/gag/response/dislike/{{$reply->id}}"><span class="glyphicon glyphicon-thumbs-down gray"></span></a>
                                                                            @elseif($rating->likes == 1 and $rating->dislikes == 0)
                                                                                <a href="/gag/response/like/{{$reply->id}}"><span class=" glyphicon glyphicon-thumbs-up green" ></span></a>
                                                                                <a href="/gag/response/dislike/{{$reply->id}}"><span class="glyphicon glyphicon-thumbs-down gray"></span></a>
                                                                            @elseif($rating->likes == 0 and $rating->dislikes == 1)
                                                                                <a href="/gag/response/like/{{$reply->id}}"><span class="glyphicon glyphicon-thumbs-up gray"></span></a>
                                                                                <a href="/gag/response/dislike/{{$reply->id}}"><span class="glyphicon glyphicon-thumbs-down red"></span></a>
                                                                            @else
